					...
					<td width="41%" align="left" valign="top" class="panelbox">
						<table width="100%">
							<tr>
								...
								<td width="319"><select name="source">
										<%
...
%>
							...
							<tr>
								<td>移动方式:</td>
								<td>
									<table id="movetype" class="buttonlist" border="0"
										style="border-width: 0px; border-style: Dotted;"
										...
										<tr>
											<td><input type="radio" name="moveType" value="0"
												checked="checked" />作为目标版块的子版块</td>
										</tr>
										<tr>
											<td><input id="rootSection" type="radio" name="moveType"
												value="1" />作为根版块</td>
										</tr>
									</table>
								</td>
					...
					<td class="panelbox" align="right" width="59%">
						<table width="100%" id="showtargetforum" style="display: block;">
							<tr>
								...
								<td width="534" align="left" valign="top"><select size="4"
									name="target" style="height: 290px;">
										<%
	if(sPid==0){
		for (int i = 0; i < clist.size(); i++) {
			//根据对象的父id 获得版块名
