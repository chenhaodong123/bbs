...
<body>
	...
	<div class="ManagerForm">
		<form name="Form1" method="post" action="../ServletManager"
			language="javascript" onsubmit="return check();" id="Form1">
			<input type="hidden" name="action" value="add" />
			<table width="968" align="center" cellpadding="4" cellspacing="0"
				id="t1">
				<tr>
					<td width="50%" align="left" valign="top" class="panelbox">
						<table width="100%">
							<tr>
								...
								<td width="338"><input class=FormBase id=sName
									onBlur="this.className='FormBase';" style="WIDTH: 200px"
									onFocus="this.className='FormFocus';" type=text name=sName>
								</td>
							</tr>
							<tr>
								<td width="98">所属类别:</td>
								<td width="374"><table width="374">
										<tr>
											<td width="232">
												<table id="" class="buttonlist"
													onclick="javascript:document.getElementById('showtargetforum').style.display= (document.getElementById('rootSection').checked ? 'none' : 'block');"
													border="0" style="border-width: 0px; border-style: Dotted;">
													<tr>
														<td><input id="rootSection" type="radio" name="sType"
															value="0" checked="checked" /> <label for="rootSection">论坛版块</label></td>
														<td><input id="leafSection" type="radio" name="sType"
															value="1" /> <label for="leafSection">论坛子版块</label></td>
													</tr>
												</table>
											</td>
											<td width="145"><div id="showtargetforum"
													style="display: none">
													<select name="select">
	...
	%>
							...
							<tr>
								...
								<td width="338"><input class=FormBase id=uName
									onBlur="this.className='FormBase';" style="WIDTH: 200px"
									onFocus="this.className='FormFocus';" type=text name=uName>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr align="center" valign="middle">
					<td class="panelbox">
						<button type="submit" class="ManagerButton" id="SubmitAdd"
							onclick="">
							<img src="image/submit.gif" /> 添 加
						</button>&nbsp;&nbsp;&nbsp;&nbsp;
						<button onclick="window.history.back();" id="Button3"
							class="ManagerButton" type="button">
							<img src="image/arrow_undo.gif" /> 返 回
						</button>
					</td>
				</tr>
			</table>
