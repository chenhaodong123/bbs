...
%>
		...
		<FORM name="loginForm" onSubmit="return check()" action="ServletLogin"
			method="post">
			用户名： <INPUT class="input" tabIndex="1" type="text" maxLength="20"
				size="35" name="uName" style="width: 225px"><Br> 密 码： <INPUT
				class="input" tabIndex="2" type="password" maxLength="20" size="40"
				name="uPass" style="width: 225px"><br> <INPUT
				class="btn" tabIndex="3" type="submit" value="登 录">
		</FORM>
		<%
	} else{
	%>
