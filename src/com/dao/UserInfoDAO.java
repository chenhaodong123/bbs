...
public class UserInfoDAO {
	...
	public boolean checkReg(String userName, String passWord, boolean sex,
			String userFace,String uregtime,Integer utype) {
		String sql = "insert into userInfo(uName,uPassWord,uSex,uFace,uRegTime,uType) values(?,?,?,?,?,?)";
		int result = -1;
		try {
			result = dao.executeUpdate(sql, new Object[] { userName, passWord,
					sex, userFace,uregtime,utype });
